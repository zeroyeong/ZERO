            ...
            <div class="viewWrap">
                ...
                <div class="imgWrap">
                    ...
                    <div class="floatWrap">
                        <div class="floatLeft">
                            <p class="tit">지점주소</p>
                            <p class="txt">전주시 완산구 기린대로 170 홈플러스 전주완산점 옥상층</p>
                        </div>
                        <div class="floatRight">
                            <p class="tit">문의전화</p>
                            <p class="txt">010-6804-0220 / 010-5420-0222 (10:00 ~ 24:00) </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="locationInfo">
                    ...
                    <p><span><i class="fa-solid fa-location-dot"></i>전라북도 전주시 완산구 기린대로 170 홈플러스 전주완산점 옥상층</span></p>
                </div>
                ...
                <div class="list_wrap">
                    ...
                    <ol type="1">
                        ...
                        <li><b>- 입금 계좌 : 국민은행 318037-04-005799 예금주 : 더피치전주완산</b></li>
                        <li>- 입금 확인 전화 : 010-5420-0222 (가능시간 : 10:00 ~ 18:00)</li>
                        <li><b>2. 문의 전화 : 010-6804-0220 / 010-5420-0222</b></li>
