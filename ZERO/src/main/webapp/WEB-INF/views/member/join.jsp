...
<html lang="ko">
  ...
  <body>
    ...
    <section class="container">
      ...
      <form action="">
        <label for="allAccept" class="checkBox">
          <input type="checkbox" name="turm" id="allAccept" onclick="selectAll(this)" />
          <span class="icon"></span>
          <span class="term">이용약관, 개인정보 수집 및 이용, 개인정보취급위탁에 모두 동의합니다.</span>
        </label>

        <div class="turmDiv">
          <label for="homepage" class="checkBox">
            <input type="checkbox" name="turm" id="homepage" />
            <span class="icon"></span>
            <span class="term">ZEROFUTSAL 홈페이지 이용약관 안내</span>
          </label>
          <div class="turm">
            <p>제 1 장 총 칙</p>
            <p class="mt">제 1 조 (목적)</p>
            <p>
              이 약관은 전기 통신 사업 법령 및 정보 통신망 이용 촉진등에 관한 법령에 의하여 HM스포츠 (이하 "회사"라
              한다)가 제공하는 홈페이지 서비스(이하 "서비스"라 한다)의 이용조건 및 절차에 관한 사항을 규정함을 목적으로
              합니다.
            </p>
            <p class="mt">제 2 조 (약관의 공지 및 준용)</p>
            <p>①이 약관의 내용은 서비스 화면에 게시하거나 기타의 방법으로 회원에게 공지함으로써 효력을 발생합니다.</p>
            <p>
              ②회사는 이 약관을 임의로 변경할 수 있으며, 변경된 약관은 제1항과 같은 방법으로 공지함으로써 효력을
              발생합니다.
            </p>
            <p class="mt">제 3 조 (약관 외 준칙)</p>
            <p>
              이 약관에 명시되지 않은 사항은 전기 통신 기본법,전기 통신 사업법, 정보 통신망 이용촉진등에 관한 법률 및
              기타 관련법령의 규정에 의합니다.
            </p>
            ...
            <p>
              -"이용약관에 동의 하십니까?" 라는 이용신청시의 물음에 회원이 "예" 단추를 누르면 이 약관에 동의하는 것으로
              간주됩니다.
            </p>
            ...
            <p>
              -온라인 가입신청 양식에 기재하는 모든 회원 정보는 실제 데이터인 것으로 간주하며 실명이나 실제 정보를
              입력하지 않은 사용자는 법적인 보호를 받을 수 없으며, 서비스 사용의 제한을 받을 수 있습니다.
            </p>
            <p class="mt">제 7 조 : 회원정보 사용에 대한 동의</p>
            <p>-회원의 개인 정보에 대해서는 회사의 개인정보 보호정책이 적용됩니다.</p>
            <p>
              -회사가 제6조에 따라 신청서에 기재를 요구하는 회원의 개인정보는 본 이용계약의 이행과 본 이용계약상의
              서비스제공을 위한 목적으로 이용합니다.
            </p>
            <p>
              -회원이 회사 및 회사와 제휴한 서비스들을 편리하게 이용할 수 있도록 하기 위해 회원 정보는 회사와 제휴한
              업체에 제공될 수 있습니다. 단, 회사는 회원 정보 제공 이전에 제휴 업체, 제공 목적, 제공할 회원 정보의 내용
              등을 사전에 공지하고 회원의 동의를 얻어야 합니다.
            </p>
            <p>-회원은 회원정보 수정을 통해 언제든지 개인 정보에 대한 열람 및 수정을 할 수 있습니다.</p>
            <p>
              -회원이 이용신청서에 회원정보를 기재하고, 회사의 본 약관에 따라 이용신청을 하는 것은 회사가 본 약관에 따라
              이용신청서에 기재된 회원정보를 수집, 이용 및 제공하는 것에 동의하는 것으로 간주됩니다.
            </p>
            <p class="mt">제 8 조 (이용신청의 승낙)</p>
            <p>
              -회사는 회원이 제 6 조에서 정한 모든 사항을 정확히 기재하여 이용신청을 하였을 때 제2호, 제3호의 경우를
              예외로 하여 승낙할 수 있습니다.
            </p>
            ...
            <p>
              회원은 이용신청시 기재한 사항이 변경되었을 경우에는 온라인으로 수정을 해야 하고 미변경으로 인하여 발생되는
              문제의 책임은 회원에게 있습니다.
            </p>
            <p>제 3 장 계약당사자의 의무</p>
            <p class="mt">제 10조 (회사의 의무)</p>
            <p>
              ①회사는 서비스 제공과 관련해서 알고 있는 회원의 신상정보를 본인의 승낙없이 제 3자에게 누설, 배포하지
              않습니다.단, 전기통신기본법 등 법률의 규정에 의해 국가기관의 요구가 있는 경우, 범죄에 대한 수사상의 목적이
              있거나 정보통신윤리 위원회의 요청이 있는 경우 또는 기타 관계법령에서 정한 절차에 따른 요청이 있는 경우에는
              그러하지 않습니다.
            </p>
            <p>
              ②1항의 범위내에서, 회사는 업무와 관련하여 회원 전체 또는 일부의 개인정보에 관한 통계 자료를 작성하여 이를
              사용할 수 있고, 서비스를 통하여 회원의 컴퓨터에 쿠키를 전송할 수 있습니다.이 경우 회원은 쿠키의 수신을
              거부하거나 쿠키의 수신에 대하여 경고하도록 사용하는 컴퓨터의 브라우져의 설정을 변경할 수 있습니다.
            </p>
            <p class="mt">제 11 조 (회원의 의무)</p>
            <p>①회원은 서비스를 이용할 때 다음 각 호의 행위를 하지 않아야 합니다.</p>
            <p>㉮다른 회원의 ID를 부정하게 사용하는 행위</p>
            <p>
              ㉯서비스에서 얻은 정보를 회사의 사전승낙 없이 회원의 이용이외의 목적으로 복제하거나 이를 출판 및 방송 등에
              사용하거나 제3자에게 제공하는 행위
            </p>
            ...
            <p>
              ④회원은 회사의 사전 승낙없이는 서비스를 이용하여 영업활동을 할 수 없으며, 영업활동의 결과와 회원이 약관에
              위반한 영업활동을 이용하여 발생한 결과에 대하여 회사는 책임을 지지 않습니다. 회원은 이와 같은 영업활동에
              대하여 회사에 대하여 손해배상의무를 집니다.
            </p>
            <p>
              ⑤회원은 회사의 명시적인 동의가 없는 한 서비스의 이용권한, 기타 이용계약상 지위를 타인에게 양도,증여할 수
              없으며, 이를 담보로 제공할 수 없습니다.
            </p>
            <p>제 4 장 서비스 이용</p>
            <p class="mt">제 12 조 (회원 아이디(ID)와 비밀번호 관리에 대한 회원의 의무)</p>
            <p>
              ①아이디(ID)와 비밀번호에 관한 모든 관리책임은 회원에게 있습니다. 회원에게 부여된 아이디(ID)와 비밀번호의
              관리소홀,부정사용에 의하여 발생하는 모든 결과에 대한 책임은 회원에게 있습니다.
            </p>
            <p>②자신의 아이디(ID)가 부정하게 사용된 경우 회원은 반드시 회사에 그 사실을 통보해야 합니다.</p>
            <p class="mt">제 13조 (정보의 제공)</p>
            <p>
              회사는 회원이 서비스 이용 중 필요가 있다고 인정되는 다양한 정보에 대해서 전자우편이나 서신우편 등의
              방법으로 회원에게 제공할 수 있으며 회원은 원치 않을 경우 가입신청메뉴와 회원정보수정 메뉴에서 정보
              수신거부를 할 수 있습니다.
            </p>
            <p class="mt">제 14 조 (회원의 게시물)</p>
            <p>
              회사는 회원이 게시하거나 등록하는 서비스내의 내용물이 다음 각 호의 1에 해당한다고 판단되는 경우에 사전통지
              없이 삭제할 수 있습니다.
            </p>
            ...
            <p>
              ①게시물에 대한 권리와 책임은 게시자에게 있으며 회사는 게시자의 동의 없이는 이를 서비스내 게재 이외에
              영리적 목적으로 사용하지 않습니다. 단, 비영리적인 경우에는 그러하지 아니하며 또한 회사는 서비스내의
              게재권을 갖습니다.
            </p>
            <p>
              ②회원은 서비스를 이용하여 얻은 정보를 가공, 판매하는 행위등 서비스에 게재된 자료를 상업적으로 사용할 수
              없습니다.
            </p>
            ...
            <p>
              ②회사는 국가비상사태, 정전, 서비스 설비의 장애 또는 서비스 이용의 폭주 등으로 정상적인 서비스 이용에
              지장이 있는 때에는 서비스의 전부 또는 일부를 제한하거나 정지할 있습니다.
            </p>
            <p>제 5 장 계약해지 및 이용제한</p>
            <p class="mt">제 19 조 (계약해지 및 이용제한)</p>
            <p>①회원이 이용계약을 해지하고자 하는 때에는 회원 본인이 온라인을 통해 회사에 해지 신청을 하여야 합니다.</p>
            <p>
              ②회사는 회원이 다음 각 호의 1에 해당하는 행위를 하였을 경우 사전통지 없이 이용계약을 해지하거나 또는
            ...
            <p>
              카.정보통신윤리위원회 등 외부기관의 시정요구가 있거나 불법선거운동과 관련하여 선거관리위원회의 유권해석을
              받은 경우
            </p>
            <p>타.타인의 개인정보, 이용자ID 및 비빌번호를 부정하게 사용하는 경우</p>
            <p>
              파.회사의 서비스 정보를 이용하여 얻은 정보를 회사의 사전 승낙없이 복제 또는 유통시키거나 상업적으로
              이용하는 경우
            </p>
            <p>하.회원이 자신의 홈페이지와 게시판에 음란물을 게재하거나 음란사이트 링크하는 경우</p>
            <p>거.본 약관을 포함하여 기타 회사가 정한 이용조건에 위반한 경우</p>
            <p>
              너. 장기간 휴면 가입자에 대하여 통지할 경우 그 통지 기간 내에도 서비스이용에 대한 의사표현을 하지 않은
              경우 전 항 규정에 의해 이용제한을 하고자 할 경우에는 제한의 종류 및 기간 등 구체적 기준은 회사의 공지,
              서비스안내, 세부규칙 등에 별도로 정하는 바에 의한다.
            </p>
            <p class="mt">제 20 조 이용제한의 해제 절차</p>
            <p>
              ①회사는 이용제한을 하고자 하는 경우에는 그 사유, 일시 및 기간을 정하여 서면 또는 전화 등의 방법을 이용하여
              해당 회원 또는 대리인에게 통지합니다.
            </p>
            <p>
              ②다만, 회사는이 긴급하게 이용을 중지해야 할 필요가 있다고 인정하는 경우에는 전항의 과정없이 서비스 이용을
              제한할 수 있습니다.
            </p>
            <p>
              ③제 21조 1항 규정에 의하여 서비스 이용중지를 통지 받은 회원 또는 그 대리인은 이용중지에 대하여 이의가 있을
              경우 이의 신청을 할 수 있습니다.
            </p>
            <p>
              ④회사는 이용중지 기간 중에 그 이용중지 사유가 해소된 것이 확인된 경우에 한하여 이용중지 조치를 즉시
              해제합니다.
            </p>
            <p>제 6 장 손해배상 등</p>
            ...
            <p>
              회사는 서비스 요금이 무료인 동안의 서비스 이용과 관련하여 회사의 고의, 과실에 의한 것이 아닌 한 회원에게
              발생한 어떠한 손해에 관하여도 책임을 지지 않습니다
            </p>
            ...
            <p>
              ③회사는 회원이 서비스를 이용하여 기대하는 수익을 상실한 것에 대하여 책임을 지지 않으며 그밖에 서비스를
            ...
            <p>
              요금 등 서비스 이용으로 발생한 분쟁에 대해 소송이 제기될 경우 회사의 본사 소재지를 관할하는 법원을 전속
              관할법원으로 합니다.
            </p>
            <p class="mt">[부칙]</p>
        ...
        <div class="turmDiv">
          <label for="userInfo" class="checkBox">
            <input type="checkbox" name="turm" id=userInfo />
            <span class="icon"></span>
            <span class="term">개인정보 수집 및 이용에 대한 안내</span>
          </label>
          <div class="turm">
            <p>
              HM스포츠(이하 회사)는 회원으로 가입한 이용자의 개인정보 보호를 위해 구체적 방침을 명시한 개인정보
              보호정책을 제정하여 준수합니다.<br />본 보호정책은 관계 법령의 변경 및 회사이 제공하는 서비스의 내용변경에
              따라 바뀔 수 있으므로 HM스포츠 홈페이지를 방문 시 수시로 확인하시기 바랍니다.
            </p>
            ...
            <p>
              ...
              확인 , 연령확인 , 만14세 미만 아동 개인정보 수집 시 법정 대리인 동의여부 확인, 불만처리 등 민원처리 ,
              고지사항 전달
            </p>
            ...
            <p>보존 기간 : 3년</p>
            <p>
              그리고 관계법령의 규정에 의하여 보존할 필요가 있는 경우 회사는 아래와 같이 관계법령에서 정한 일정한 기간
              동안 회원정보를 보관합니다.
            </p>
        ...
        <div class="turmDiv">
          <label for="userInfotrust" class="checkBox">
            <input type="checkbox" name="turm" id="userInfotrust" />
            <span class="icon"></span>
            <span class="term">개인정보 취급위탁 안내</span>
          </label>
          <div class="turm">
        ...
        <div class="btnBox">
          <button type="button" onclick="document.location.href='/zero';">비동의</button>
          <button type="button" class="accept" onClick="frmSubmit()">동의</button>
        </div>
      </form>
